      ...
      res.map((row) => {
        display.innerHTML += `
          <div class="card winecard mb-3 mx-2">
            ...
            <img src="./assets/img/uploads/${row.picture}" alt="Photo de ${
          row.name
        }" />
            <div class="card-body">
            ...
            <ul class="list-group list-group-flush">
              <li class="list-group-item">Millésime : <span class="text-info">${
                row.millesime
              }</span></li>
              <li class="list-group-item">Cépages : <span class="text-muted">${
                row.cepages
              }</span></li>
            </ul>
            ${
